...
Esta nota conceptual consolidada presenta las recomendaciones, los mecanismos y el posicionamiento inicial elaborados por los responsables de producto de diversos Bienes Públicos Digitales (DPG) en el ámbito de los contenidos y datos abiertos. El documento responde a retos y preocupaciones comunes detallados en las secciones siguientes. Su objetivo principal es abordar los desafíos prácticos asociados al consumo, procesamiento y uso de contenidos y datos abiertos por parte de empresas comerciales de modelos de lenguaje a gran escala (LLM), entidades de inteligencia artificial y otras organizaciones de investigación no comerciales <sup>**1**</sup>.

Las recomendaciones expuestas surgen de la necesidad consensuada de salvaguardar el carácter abierto y de bien público de los datos y contenidos de los DPG. Concretamente, buscan asegurar el respeto a la intención original y las licencias vigentes, así como garantizar que el valor generado por estos recursos se reinvierta y reconozca de manera justa, beneficiando a las comunidades y a las partes interesadas responsables de su creación. <sup>**2**</sup>. 
...
Los LLM generan beneficios comerciales masivos al recopilar, entrenar y reformular contenidos de bien público en productos propietarios. Mientras el sector del bien público proporciona la "materia prima"  escencial, existe una asimetría crítica: no hay retorno de valor hacia quienes crearon la materia prima. Falta un mecanismo que garantice reciprocidad, reconocimiento y reinvversión sostenible en el ecosistema de los DPG<sup>**4**</sup>. 
