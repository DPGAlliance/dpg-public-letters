---
layout: default
title: Mejores prácticas para proteger datos y contenidos abiertos ante del uso indebido de la IA
...
| Índice |
| :--- |
| [1.0 Introducción y propósito](#10-introducción-y-propósito) |
...
La presente nota conceptual recoge un conjunto consolidado de recomendaciones, mecanismos y una posicionamiento inicial elaborado por los responsables de productos de Bienes Públicos Digitales (DPG por sus siglas en inglés) de diversos DPG de contenidos abiertos y datos abiertos, en respuesta a los retos y preocupaciones comunes que se describen en las secciones siguientes. Su objetivo principal es abordar los retos prácticos emergentes asociados al consumo, procesamiento y uso de contenidos abiertos y datos abiertos procedentes de los Bienes Públicos Digitales por parte de empresas comerciales de modelos de lenguaje a gran escala (LLM), entidades de inteligencia artificial y otras organizaciones de investigación no comerciales <sup>**1**</sup>.

Las recomendaciones aquí expuestas surgen de la necesidad compartida de garantizar que se preserve el carácter abierto y de bien público de los datos y contenidos de los DPG, que se respeten la intención original y las licencias, y que el valor generado por estos recursos de bien público se reinvierta y se reconozca de forma justa, de manera que beneficie a las comunidades y a las partes interesadas que los crearon <sup>**2**</sup>. 
...
Los modelos de lenguaje a gran escala (LLM) generan un valor comercial significativo al recopilar, entrenar y reformular contenidos creados para el bien público. Esta dinámica genera un desequilibrio de poder importante en la capacidad de utilizar los datos y obtener valor de ellos. Así, el sector del bien-público proporciona la "materia prima" fundamental para productos comerciales y no-comerciales de propiedad privada, pero se carece de un mecanismo para el intercambio recíproco de valor, el reconocimiento o la reinversión en el ecosistema de los DPG<sup>**4**</sup>. 

Entre los principales retos a los que se enfrentan los responsables de producto de DPG se incluyen:
...
3. **Sostenibilidad financiera**: La financiación tradicional mediante subvenciones es cada vez menos viable, y la recaudación de fondos resulta más difícil, ya que los financiadores están orientando sus programas hacia iniciativas de IA. Al mismo tiempo, el declive del tráfico y las visitas compromete el argumento de sostenibilidad basado en una comunidad de usuarios consolidada. Cada vez más organizaciones se muestran cautelosas a la hora de compartir datos de forma abierta o escépticas respecto a invertir en el desarrollo de contenidos abiertos debido a la preocupación por la extracción de valor.
  
4. **Falta de transparencia y de mecanismos de exclusión voluntaria**: Actualmente no existe una norma ni una cultura establecidas para declarar el uso de los datos en la IA, ya sea de forma consciente o inadvertida. Los DPG a menudo carecen de una visibilidad clara sobre qué entidades comerciales o no comerciales de modelos de lenguaje a gran escala (LLM) están utilizando su contenido, cómo se está utilizando, o de un mecanismo sencillo para entablar un diálogo, colaborar en objetivos comunes, solicitar el cumplimiento de directrices éticas específicas o "excluirse" (opt-out) de manera efectiva de determinados usos de alto riesgo. La escasa divulgación de cómo y por qué las principales empresas de IA utilizan los datos también dificulta que las organizaciones midan el impacto, protejan sus activos y aseguren la financiación a largo plazo.

5. **Amenazas al modelo de contribución**: Los modelos de contribución comunitaria están en peligro, ya que empresas extraen datos y contenidos creados por voluntarios sin hacer una inversión recíproca clara en la sostenibilidad del proyecto, generar incentivos para los colaboradores o sin respetar la gobernanza abierta. Del mismo modo, cuando los LLM se interponen entre el DPG y su usuario final, el contacto y la buena voluntad o motivación que generaron y sostienen el DPG comienzan a desvanecerse. Si los colaboradores perciben que su trabajo ya no es respetado, reconocido o recompensado, es posible que no vean ningún beneficio en participar y apoyar el desarrollo de los DPG.

6. **Impacto negativo en la comunidad de los DPG**: El uso creciente de modelos de lenguaje grande (LLM) sin consentimiento está forzando a las comunidades de DPG a crear nuevas políticas y medidas de protección. Esto desvía la capacidad limitada de equipos y voluntarios hacia la resolución de desafíos relacionados con la IA, restando tiempo necesario para el mantenimiento y desarrollo de datos y contenidos abiertos. Además, las posibles medidas para prohibir a empresas comerciales el acceso a estos recursos estarían en tensión con los principios del código abierto y las licencias que rigen los DPG, afectando también a usuarios legítimos que desean apoyar de forma justa a la iniciativa. En definitiva, si el apoyo comunitario disminuye o la participación se vuelve más compleja, toda la infraestructura humana detrás de los DPG corre riesgo de colapso.
